...
export const legalSections: LegalSection[] = [
  {
    ...
    content: [
      'Marie Odin — Avocate au Barreau de Paris',
      'Marie Odin, avocate inscrite au Barreau de Paris depuis janvier 2022',
      'N° RPVA : en attente',
      'N° SIREN : en attente',
      'Adresse : 16 cours Albert 1er, 75008 Paris',
      'Téléphone : +33 1 58 18 30 30',
      'Email : modin@svz.fr',
      'Assurance responsabilité civile professionnelle : en attente',
    ],
  },
  {
    title: 'Hébergement',
    content: [
      'Ce site est hébergé par : en attente de confirmation',
      'Adresse hébergeur : en attente',
      'Site hébergeur : en attente',
    ],
  },
  {
    title: 'Règles professionnelles',
    content: [
      "Marie Odin est avocate inscrite au Barreau de Paris, régie par le Règlement Intérieur National (RIN) de la profession d'avocat.",
  ...
  },
  {
    ...
    content: [
      "L'ensemble du contenu de ce site (textes, images, graphismes, logo) est la propriété exclusive de Marie Odin.",
  ...
  },
  {
    ...
    content: [
      'Marie Odin traite les données personnelles collectées via le formulaire de contact conformément au Règlement (UE) 2016/679 (RGPD).',
      'Responsable de traitement : Marie Odin, modin@svz.fr',
      ...
      'Pour exercer ces droits : modin@svz.fr',
  ...
  },
  {
    ...
    content: [
      ...
      "Marie Odin ne saurait être tenue responsable des conséquences découlant d'une utilisation des informations publiées sur ce site sans consultation préalable.",
